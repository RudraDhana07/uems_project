# backend/scripts/load_lthw_data.py
...
from app.services.lthw_loader import LTHWLoader
...
def main():
    ...
    try:
        logger.info(f"Loading LTHW data from: {excel_file}")
        
        # Initialize loader
        loader = LTHWLoader(db_url)
