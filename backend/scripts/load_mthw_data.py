# backend/scripts/load_mthw_data.py
...
from app.services.mthw_loader import MTHWLoader
...
def main():
    ...
    try:
        logger.info(f"Loading MTHW data from: {excel_file}")
        
        # Initialize loader
        loader = MTHWLoader(db_url)
