# backend/app/models/auckland_electricity.py

from .. import db
from datetime import datetime

class AucklandElectricityCalculatedConsumption(db.Model):
    __tablename__ = 'auckland_electricity_calculated_consumption'
